...
main_dir = "E:\\ese_tesi\\" # main directory where you are working/saving the resulting structures and matrixes ||| you can delete this line and paste directly the specific folders you want to use. They do not need to be in the same directory
